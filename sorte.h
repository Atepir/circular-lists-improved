...
/**
 * \def TYPE_S
 * \brief Type utilisé pour la sorte S
 * \ingroup S_module
 */

/**
 * \def PRI_S
 * \brief Chaîne de format pour les fonctions de la famille printf()
 * \ingroup S_module
 */

/**
 * \def SCN_S
 * \brief Chaîne de format pour les fonctions de la famille scanf()
 * \ingroup S_module
 */
